  		...
  		echo '<div id="new_to_starma">';
    		...
    		//js_more_link ("js_user_frame", $num_pages, $current_page, $height_inc, $num_users);
  			echo '<div id="s_top_bar">';
  				...
  				echo '<div class="pop_guest_click" style="display:inline-block; margin-bottom: 10px;"><input type="text" id="cue_search" placeholder="Search by Username or Email" disabled><div class="later_on pointer" id="cue_button">Go!</div></div>';
