$(document).ready(function(){
	...
	function msieversion() {
        ...
        if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./))      // If Internet Explorer, return version number
        	...
        	alert('Certain parts of Starma.com may not load properly on Internet Explorer.  For a more enjoyable experience we recommend using a recent version of Firefox or Chrome.  Thank you! :)');
