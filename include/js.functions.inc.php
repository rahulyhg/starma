...
function js_more_link ($div_name, $num_pages, $current_page, $height_inc, $num_users) {
   ...
   */
     ...
     echo '<div id="view_select">';
         ...
         echo '<a style="display:none; margin-left: 123px;" id="view_pages" onclick="change_height_inc(792); change_num_pages (' .  $num_users . '); change_page( parseInt(1)); animate_page_turn(\'' . $div_name . '\'); $(\'#view_all\').show(); $(\'#view_pages\').hide(); $(\'#js_back_to_top\').fadeTo(200,0); $(\'#js_back_to_top\').hide(); return false;" href="">View Pages</a>';
     echo '</div>';
