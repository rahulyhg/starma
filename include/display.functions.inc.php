    ...
    echo '<tr>';
      ...
      while ($x<4) {
        if (!empty($my_photos[$x])) {
          echo '<td class="has_photo"><div class="has_photo"><div class="make_profile_pic later_on">Make Profile Pic</div>' . $my_photos[$x] . '<div class="delete_photo later_on">Delete</div>' . $my_photo_ids[$x] . '</div></td>';
        }
        else {
