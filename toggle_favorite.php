...
if (isset($_GET["favorite"]) && isset($_GET["favorite_user_id"])) {
  ...
  $favorite_user_id = (int) $_GET["favorite_user_id"];  
    ...
    header( 'Location: https://www.' . $domain . '/main.php?the_page=cosel&the_left=nav1&tier=3&stage=2&chart_id1=' . get_my_chart_id() . '&chart_id2=' . chart_already_there("Main", $favorite_user_id));   
