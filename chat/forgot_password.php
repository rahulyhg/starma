...
require_once('ajax_header.php');
	...
	if ($fp_email) {
		if ($fp_email == 'success'){
			$data['message'] = 'A temporary password has been sent to your email.  If you don\'t see an email from Starma, please check your spam folder and add "contact@starma.com" to your contacts';
		}
